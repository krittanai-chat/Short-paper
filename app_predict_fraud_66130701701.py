...
def predict_fraud(txn_type, amount, oldbalanceOrg, newbalanceOrig, oldbalanceDest, newbalanceDest):
...
if st.button("ทำนายการฉ้อโกง"):
    result = predict_fraud(txn_type, amount, oldbalanceOrg, newbalanceOrig, oldbalanceDest, newbalanceDest)
